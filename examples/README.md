...
This is a guided, interactive introduction to the IceCap Framework. It will lead
you through each layer of the framework with the help of the example systems in
this directory. If you encounter problems or have questions of any kind, please
raise an issue or reach out to [Nick Spinale
...
using Docker, see the [Hacking Guide](../docs/hacking-guide.md) for information
about using our Nix remote cache.  If you want to incorporate IceCap into a
build system without Nix, see [Building without
