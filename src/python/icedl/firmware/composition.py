...
class Composition(BaseComposition):
    ...
    def compose(self):
        ...
        self.host_vm.map_con(cfg['ring_buffer_objs'])
        ...
        for i in range(self.num_realms()):
            ...
            self.resource_server.add_extern('realm_{}_serial_server_read_signal'.format(i), 'Notification', serial_server_config['nfn_read'])
            self.resource_server.add_extern('realm_{}_serial_server_write_signal'.format(i), 'Notification', serial_server_config['nfn_write'])
