...
pub fn text() -> Range<usize> {
    unsafe {
        c::icecap_runtime_text_start..c::icecap_runtime_text_end
    }
}
pub fn eh_frame_hdr() -> Range<usize> {
    unsafe {
        c::icecap_runtime_eh_frame_hdr_start..c::icecap_runtime_eh_frame_hdr_end
    }
}

pub fn eh_frame_end() -> usize {
    unsafe {
        c::icecap_runtime_eh_frame_end
    }
}
