...
host_vm = composition.component(HostVM, 'host_vm', 'host_vmm', affinities=[0], gic_vcpu_frame=gic_vcpu_frame)
host_vmm = host_vm.vmm
guest_vm = composition.component(VM, 'guest_vm', 'guest_vmm', affinities=[3], gic_vcpu_frame=gic_vcpu_frame)
